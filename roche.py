...
class roche(object):
    ...
    def crawler_news(self):
        ...
        bulk_obj = DbOperations.Get_object_for_bulkop(False,'roche_news')
            ...
            for news in news_data:
                ...
                news_dict.update(
                    {"title": title, "url": url, "formatted_sub_header": title, "description": description, "link": url,
                     "publishedAt":publish_date,'date':publish_date,"news_provider": "roche"})
...
news_obj = roche(url,body,headers)
